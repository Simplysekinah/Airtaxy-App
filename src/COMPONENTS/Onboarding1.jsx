        ...
        <>
            <div className='container-fluid secondpage'>
                <div className='thirdpage-one'>
                    <div className='text-center  m-auto'><img className='onb-plane img-fluid mt-5' src={onboard1} alt="" /></div>
                    ...
                    <div className='onboard1-next mt-5'>
                        <div style={{ width: 200, height: 200, position: 'relative' }} className='text-center'>
                            <CircularProgressbar
                                value={percentage}
                                text={`${percentage}%`}
